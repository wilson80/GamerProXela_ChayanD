 ...
 * @author Jonwil
 */
public class panel_Bodeguero extends javax.swing.JPanel {
    private Control control;
    private int alturaItem = 60;
    private int altura = 0;
    private int contadorPaneles = 0;
    
    private LinkedList<panelItem_Factura> items;
    private LinkedList<panelItem_Factura> itemsFinal;
    ...
    public panel_Bodeguero(Control control) {
        initComponents();
...
//                update.ingresarProductos(5, "halo1");
            for (panelItem_Factura item : itemsFinal) {
                Producto_querys update = new Producto_querys();
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if(productEncontrado!=null){
              panelItem_Factura nuevoPanel = new panelItem_Factura(this);
